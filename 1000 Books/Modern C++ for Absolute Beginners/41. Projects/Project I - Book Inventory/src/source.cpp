...
// This constructor would be invoked when we want to create an object with no parameters.
Book::Book()
    : title{ "Default Book Title" }, pages{ 0 }
{
}

Book::Book(const std::string& atitle, int apages)
    : title{ atitle }, pages{ apages }
{
}
